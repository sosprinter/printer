<?php
class TwitterBootstrap_Helper_FlashMessenger extends Zend_View_Helper_Abstract
{
    /**
    ...
    public function flashMessenger($key = 'warning')
    {
        ...
        $template = <<<EOF
            <div class="alert alert-%s" style="margin-top:5px" >
...
EOF;
        ...
        foreach ($messages as $message)
        {
            ...
            $output .= sprintf($template,$key,ucfirst($key),$message);
        }
